...
export default function About() {
  return (
    <Container className="py-5">
      <h1 className="text-center mb-5">About CarMarket</h1>
      <Row className="mb-5">
        <Col lg={8} className="mx-auto">
          <p className="lead text-center">CarMarket is your trusted online platform for buying and selling cars. We connect buyers with verified sellers and make the process simple, transparent, and secure.</p>
        </Col>
      </Row>
